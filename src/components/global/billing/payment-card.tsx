    ...
    return (
        <div className={cn(
            ...
            <div className={cn(
                ...
                <p className='text-text-secondary text-sm mb-2'>This is what your plan covers for automations and Ai features</p>

                {label === 'PRO' ? (
                    <span className='bg-gradient-to-r text-3xl from-indigo-500 via-purple-500 to-pink-500 font-bold bg-clip-text text-transparent'>Smart AI</span>
                ) : (
                ...
                {landing ? (
                    <Button
                        className={cn('rounded-full mt-5',
                            label === 'PRO'
